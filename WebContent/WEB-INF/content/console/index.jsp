...
<html>
  <head>
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="${root}/theme/plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="${root}/theme/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="${root}/theme/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="${root}/theme/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="${root}/theme/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> ChartJS</a></li>
                <li><a href="${root}/theme/pages/charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
                <li><a href="${root}/theme/pages/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
                <li><a href="${root}/theme/pages/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
    ...
    <script src="${root}/theme/plugins/morris/morris.min.js"></script>
    <!-- Sparkline -->
    <script src="${root}/theme/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!-- jvectormap -->
    <script src="${root}/theme/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${root}/theme/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- jQuery Knob Chart -->
